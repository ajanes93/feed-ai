        ...
        >
          <div>
            ...
            <p>
              ...
              ability. 59.4% of hard tasks have broken tests that reject correct
              solutions.
              <a
                href="https://openai.com/index/why-we-no-longer-evaluate-swe-bench-verified/"
                target="_blank"
          ...
          <div>
            ...
            <p>
              ...
              test leniency and requirements inflation. No benchmark is perfect,
              which is why this site tracks multiple independent sources
              (SWE-bench Pro, SanityHarness, FRED labour data).
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              SWE-bench Pro Public ({{ pro }}) uses GPL repos AI is unlikely to
              have trained on. Pro Private ({{ proPrivateDisplay }}) uses truly
              proprietary startup code. The gap between these numbers reveals
              how much benchmark scores depend on data familiarity.
            </p>
          </div>
